    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="flex items-center justify-between px-6 py-4 border-b border-slate-200">
        ...
        <div className="flex items-center gap-4">
          <Link 
            to="/tools/plagiarism" 
            className="text-sm font-semibold text-indigo-600 hover:text-indigo-800 transition-colors hidden sm:inline-block"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <button 
                onClick={() => navigate('/tools/plagiarism')}
                className="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-xl flex items-center gap-2 shadow-lg shadow-indigo-600/20 transition-colors cursor-pointer"
              >
                <span>Check Your Work Free</span>
            ...
            <div className="bg-slate-50 border border-slate-200/90 rounded-2xl p-5 shadow-xs space-y-3">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
                {[
                  { name: 'Originality Check', icon: '🔍', path: '/tools/plagiarism' },
      ...
      {/* FEATURE: Free Academic Originality & Evidence Check */}
      <section className="max-w-6xl mx-auto px-6 py-12 border-t border-slate-100 bg-slate-50/60 rounded-3xl my-8">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <span className="inline-flex items-center gap-1.5 bg-indigo-50 border border-indigo-200 rounded-full px-3.5 py-1 text-xs text-indigo-700 font-bold">
            <Sparkles className="w-3.5 h-3.5 text-indigo-600" /> Evidence-Based Academic Analysis
          </span>
          <h2 className="text-2xl md:text-3xl font-bold text-slate-900">
            Check Academic Originality & Evidence
          </h2>
          <p className="text-sm text-slate-600 leading-relaxed">
            Check academic originality and discover relevant evidence from scholarly sources and books.
          </p>
          <div className="pt-2">
            <button
              onClick={() => navigate('/tools/plagiarism')}
              className="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs rounded-xl shadow-md transition-all cursor-pointer inline-flex items-center gap-2"
            >
              <span>Check Your Work Free</span>
              <ArrowRight className="w-4 h-4" />
            </button>
